                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            // Query to select all dishes from the database
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                // Loop through each dish and display its details
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    // Query to get the featured food associated with the dish
                                                    $mql = "SELECT * FROM featured_food WHERE ff_id='" . $rows['ff_id'] . "'";
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td>
                                                                <a href="delete_menu.php?menu_del=' . $rows['d_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i>Delete</a> 
                                                                <a href="update_menu.php?menu_upd=' . $rows['d_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i>Edit</a>
                                                            </td>
                                                        </tr>';
                                                }	
                                            }
