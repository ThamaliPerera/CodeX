...
<head>
    ...
    <title>All Users</title> <!-- Page title -->
            ...
            <div class="container-fluid"> <!-- Container for fluid layout -->
                <div class="row"> <!-- Row for layout -->
                    <div class="col-12"> <!-- Full width column -->
                        <div class="col-lg-12"> <!-- Column for users table -->
                            <div class="card card-outline-primary"> <!-- Card for users section -->
                                <div class="card-header"> <!-- Card header -->
                                    <h4 class="m-b-0 text-white">All Users</h4> <!-- Title for users section -->
                                </div>
                                <div class="table-responsive m-t-40"> <!-- Responsive table -->
                                    <table id="myTable" class="table table-bordered table-striped table-hover"> <!-- Table for displaying users -->
                                        <thead class="thead-dark"> <!-- Table header -->
                                            <tr>
                                                <th>Username</th> <!-- Username column -->
                                                <th>FirstName</th> <!-- First name column -->
                                                <th>LastName</th> <!-- Last name column -->
                                                <th>Email</th> <!-- Email column -->
                                                <th>Phone</th> <!-- Phone column -->
                                                <th>Address</th> <!-- Address column -->
                                                <th>Reg-Date</th> <!-- Registration date column -->
                                                <th>Loyalty-Points</th> <!-- Loyalty points column -->
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if (!mysqli_num_rows($query) > 0) {
                                                    echo '<td colspan="8"><center>No Users</center></td>'; // Display message if no users
                                                } else {				
                                                    ...
                                                    while ($rows = mysqli_fetch_array($query)) {
                                                        echo '<tr>
                                                                ...
                                                                <td>' . htmlspecialchars($rows['loyalty_points']) . '</td>
                                                                <td>
                               ...
                               <i class="fa fa-edit"></i> Edit
                                                            ...
                                                            </tr>'; // Display user details in table row
                                                    }	
                                                }
                                            ?>
                                        </tbody>
