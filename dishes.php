...
// Include product action script for handling cart actions
...
<body>
                ...
                <div class="collapse navbar-toggleable-md float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        if(empty($_SESSION["user_id"])) {
                            // Show login and registration links if user is logged out
                            echo '<li class="nav-item"><a href="login.php" class="nav-link active">Login</a> </li>
                                  <li class="nav-item"><a href="registration.php" class="nav-link active">Register</a> </li>';
                        } else {
                            // Show loyalty, orders, and logout links if user is logged in
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    <!-- Top links section for navigation -->
        ...
        <?php 
        // Fetch restaurant details based on the provided ID
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                <?php
                                $item_total = 0; // Initialize total price
                                ...
                                <?php
                                $item_total += ($item["price"] * $item["quantity"]); // Calculate total price
                                }
                                ?>								  
                            </div>
                        </div>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <p>LKR 400</p> <!-- Delivery charge -->
                                <?php
                                // Checkout button logic based on cart total
                                if($item_total == 0) {
                                ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
                            // Fetch dishes based on the restaurant ID
